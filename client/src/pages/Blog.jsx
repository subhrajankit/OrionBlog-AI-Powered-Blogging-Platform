...
const Blog = () => {
    ...
    return data? (
        <div className='relative'>
            <img src= {assets.gradientBackground} alt="" className='
           ...
           <div className='text-center mt-20 text-grey-600'>
                ...
                border-primary/35 bg-primary/5 font-medium text-primary'>Ankit Kumar</p>
           </div>
           ...
           <div className='mt-14 mb-10 max-w-3xl mx-auto'>
                ...
                <div className='flex flex-col gap-4'>
                    {comments.map((item, index) => (
                        <div key={index} className='relative bg-primary/2 border border-primary/5 max-w-xl
                        p-4 rounded text-gray-600'>
                            ...
                            text-xs'>{Moment(item.createdAt).fromNow()}</div>
                        </div>
                    ))}
                </div>                 
            </div>
            ...
            <div className='my-24 max-w-3xl mx-auto'>
                ...
                <div className = 'flex'>
                    ...
                    <img src={assets.linkedin_icon} alt="" width={50}/>
