  ...
  return (
    <div className = 'mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className ='text-center mt-20 mb-8'>
            ...
            text-gray-500'>This is your space to think out loud, to share what matters, and to write 
            filters. Whether it's one word or a thousand, your story starts right here.</p>

            <form className='flex justify-between max-w-lg max-sm:scare-75 mx-auto
